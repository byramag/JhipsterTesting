...
import edu.vcu.tams.repository.CourseRepository;
...
public class CourseResourceIntTest {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course()
            ...
            .courseDesc(DEFAULT_COURSE_DESC);
        return course;
    }
    ...
    public void createCourse() throws Exception {
        ...
        assertThat(testCourse.getCourseDesc()).isEqualTo(DEFAULT_COURSE_DESC);
    }
    ...
    public void getAllCourses() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].courseDesc").value(hasItem(DEFAULT_COURSE_DESC.toString())));
    }
    ...
    public void getCourse() throws Exception {
        ...
        restCourseMockMvc.perform(get("/api/courses/{id}", course.getId()))
            ...
            .andExpect(jsonPath("$.courseDesc").value(DEFAULT_COURSE_DESC.toString()));
    }
    ...
    public void updateCourse() throws Exception {
        ...
        updatedCourse
            ...
            .courseDesc(UPDATED_COURSE_DESC);
        ...
        assertThat(testCourse.getCourseDesc()).isEqualTo(UPDATED_COURSE_DESC);
    }
