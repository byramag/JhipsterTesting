...
public class FacultyResourceIntTest {
    ...
    private static final String DEFAULT_PROF_ID = "AAAAAAAAAA";
    private static final String UPDATED_PROF_ID = "BBBBBBBBBB";

    private static final String DEFAULT_PROF_NAME = "AAAAAAAAAA";
    private static final String UPDATED_PROF_NAME = "BBBBBBBBBB";
    ...
    public void createFaculty() throws Exception {
        ...
        assertThat(testFaculty.getProfID()).isEqualTo(DEFAULT_PROF_ID);
        assertThat(testFaculty.getProfName()).isEqualTo(DEFAULT_PROF_NAME);
    ...
    public void getAllFaculties() throws Exception {
        ...
        restFacultyMockMvc.perform(get("/api/faculties?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].profID").value(hasItem(DEFAULT_PROF_ID.toString())))
            .andExpect(jsonPath("$.[*].profName").value(hasItem(DEFAULT_PROF_NAME.toString())))
            .andExpect(jsonPath("$.[*].email").value(hasItem(DEFAULT_EMAIL.toString())));
    }
    
    @SuppressWarnings({"unchecked"})
    public void getAllFacultiesWithEagerRelationshipsIsEnabled() throws Exception {
        FacultyResource facultyResource = new FacultyResource(facultyRepositoryMock);
        when(facultyRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
        ...
        verify(facultyRepositoryMock, times(1)).findAllWithEagerRelationships(any());
    }
    ...
    public void getFaculty() throws Exception {
        ...
        restFacultyMockMvc.perform(get("/api/faculties/{id}", faculty.getId()))
            ...
            .andExpect(jsonPath("$.profID").value(DEFAULT_PROF_ID.toString()))
            .andExpect(jsonPath("$.profName").value(DEFAULT_PROF_NAME.toString()))
    ...
    public void updateFaculty() throws Exception {
        ...
        updatedFaculty
            .profID(UPDATED_PROF_ID)
            .profName(UPDATED_PROF_NAME)
            .email(UPDATED_EMAIL);
        ...
        Faculty testFaculty = facultyList.get(facultyList.size() - 1);
        assertThat(testFaculty.getProfID()).isEqualTo(UPDATED_PROF_ID);
        assertThat(testFaculty.getProfName()).isEqualTo(UPDATED_PROF_NAME);
