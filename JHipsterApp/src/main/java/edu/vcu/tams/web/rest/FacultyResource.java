...
public class FacultyResource {
    ...
    public List<Faculty> getAllFaculties(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Faculties");
        return facultyRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Faculty> getFaculty(@PathVariable Long id) {
        ...
        Optional<Faculty> faculty = facultyRepository.findOneWithEagerRelationships(id);
