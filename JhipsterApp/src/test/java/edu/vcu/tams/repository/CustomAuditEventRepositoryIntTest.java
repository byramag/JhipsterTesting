...
import edu.vcu.tams.config.audit.AuditEventConverter;
import edu.vcu.tams.domain.PersistentAuditEvent;
...
import static edu.vcu.tams.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
